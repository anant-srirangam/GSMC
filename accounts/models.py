...
def user_directory_path_company(instance, filename):
    ...
    return 'Employer/user_{0}/logo.{1}'.format(instance.user.id, ext)
...
class Profile(models.Model):
    ...
    companyURL = models.TextField(max_length=2083)
    ...
    companyLogo = models.ImageField(upload_to=user_directory_path_company)
